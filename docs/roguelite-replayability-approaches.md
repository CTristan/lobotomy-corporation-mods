...
- **Research:** Slay the Spire (92) is the keystone for contextual piece value. Balatro (84) shows emergent synergy from a tiny fixed set, the poker hands, recombined through a 150-plus joker pool, Monster Train (80) layers synergy further, and Blue Prince (83) supplies the day-draft structure while doubling as a case study in its failure mode (RNG that blocks applying already-earned knowledge).
