...
{
    public sealed class MissingPatchInfo
    {
        public MissingPatchInfo(string patchAssembly, string targetType, string targetMethod, string patchMethod, PatchType patchType)
        {
