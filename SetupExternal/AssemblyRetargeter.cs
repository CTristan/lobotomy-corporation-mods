        ...
        try
        {
            ...
            using (var assembly = AssemblyDefinition.ReadAssembly(dllPath, readerParameters))
            {
                ...
                if (mscorlibRefs.Count > 1)
                {
                    ...
                    var allTypeRefs = assembly.MainModule.GetTypeReferences().ToList();
                    ...
                    var refsToRemove = mscorlibRefs.Skip(1).ToList();
                    ...
                    foreach (var removeRef in refsToRemove)
                    {
                        ...
                        assembly.MainModule.AssemblyReferences.Remove(removeRef);
                    }
