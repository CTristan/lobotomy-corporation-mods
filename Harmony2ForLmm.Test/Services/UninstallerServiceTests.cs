...
namespace Harmony2ForLmm.Test.Services
{
    ...
    public sealed class UninstallerServiceTests : IDisposable
    {
        ...
        public UninstallerServiceTests()
        {
            ...
            _service = new UninstallerService(_mockAnalyzer.Object, _mockManifest.Object);
        }
        ...
        [Fact]
        public void Uninstall_deletes_manifest()
        {
            _service.Uninstall(_gameDir, removeBaseMods: false);

            _mockManifest.Verify(m => m.DeleteManifest(_gameDir), Times.Once);
        }
