...
public class LaunchCommand
{
    ...
    public LaunchCommand(IConfigManager configManager, IFileSystem fileSystem, ProcessManager processManager)
    {
    ...
    public int Run(string[] args)
    {
        ...
        catch (Exception ex) when (ex is FileNotFoundException || ex is NotImplementedException)
        {
    ...
    private static void LaunchGame(string gamePath, string? bottleName)
    {
        ...
        {
            // macOS: Use CrossOver
            var cxstartPath = FindCxstartPath();
            if (cxstartPath == null)
            {
