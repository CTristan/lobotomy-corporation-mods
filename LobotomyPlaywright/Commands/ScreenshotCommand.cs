...
namespace LobotomyPlaywright.Commands
{
    ...
    public class ScreenshotCommand(IConfigManager configManager, Func<ITcpClient> tcpClientFactory)
    {
        ...
        private static ParseArgsResult ParseAndValidateArgs(string[] args)
        {
            ...
            if (formatArg is not "base64" and not "path")
            {
            ...
            if (displayFormat is not "text" and not "json")
            {
