...
{
    internal static class TestUnityExtensions
    {
        ...
        public static ManagementSlot CreateManagementSlot()
        {
            CreateUninitializedObject<ManagementSlot>(out var managementSlot);

            var fields = GetUninitializedObjectFields(managementSlot.GetType());
            var newValues = new Dictionary<string, object>();
