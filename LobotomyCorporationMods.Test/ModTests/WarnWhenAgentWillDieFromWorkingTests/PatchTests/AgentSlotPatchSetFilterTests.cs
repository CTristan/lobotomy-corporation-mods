...
namespace LobotomyCorporationMods.Test.ModTests.WarnWhenAgentWillDieFromWorkingTests.PatchTests
{
    public sealed class AgentSlotPatchSetFilterTests : WarnWhenAgentWillDieFromWorkingModTests
    {
        ...
        {
            MockImageInternals.SetupProperty(adapter => adapter.Color);
            MockTextInternals.SetupProperty(adapter => adapter.Text);
        ...
        public void BeautyAndTheBeast_Will_Not_Kill_Agent_If_Performing_Repression_Work_While_Not_Weak()
        {
            ...
            MockBeautyBeastAnimInternals.Setup(adapter => adapter.State).Returns(NormalState);
        ...
        public void BeautyAndTheBeast_Will_Kill_Agent_If_Performing_Repression_Work_While_Weak()
        {
            ...
            MockBeautyBeastAnimInternals.Setup(adapter => adapter.State).Returns(WeakenedState);
