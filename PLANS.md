...
| Completed | AutoFixture + AutoMoq | [`PLAN-AutoFixture.md`](PLAN-AutoFixture.md) | 8/8 (100%) | Adopt AutoFixture + AutoMoq to reduce test boilerplate and enable anonymous test data |
