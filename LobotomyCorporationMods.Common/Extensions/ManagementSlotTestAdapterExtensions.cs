...
namespace LobotomyCorporationMods.Common.Extensions
{
    internal static class ManagementSlotTestAdapterExtensions
    {
        ...
        internal static IGameObjectTestAdapter CreateImageObjectTestAdapter(
            [NotNull] this IManagementSlotTestAdapter managementSlotTestAdapter,
        ...
        )
        {
            ...
            testAdapterParameters.SpriteTestAdapter =
                testAdapterParameters.SpriteTestAdapter.EnsureNotNullWithMethod(
                    () => new SpriteTestAdapter(new Sprite())
                );
            ...
            testAdapterParameters.GameObjectTestAdapter =
                testAdapterParameters.GameObjectTestAdapter.EnsureNotNullWithMethod(
                    () => new GameObjectTestAdapter(new GameObject())
                );
            ...
            imageGameObjectTestAdapter.Transform.LocalScale = new Vector3(
                imageParameters.LocalScaleX,
                imageParameters.LocalScaleY
            );
            imageGameObjectTestAdapter.Transform.LocalPosition = new Vector3(
                imageParameters.LocalPositionX,
                imageParameters.LocalPositionY,
                imageParameters.LocalPositionZ
            );
            imageGameObjectTestAdapter.SetActive(true);

            var texture2dTestAdapter = testAdapterParameters.Texture2DTestAdapter;
            var sprite = testAdapterParameters.SpriteTestAdapter.Create(
                texture2dTestAdapter.GameObject,
                new Rect(0f, 0f, texture2dTestAdapter.Width, texture2dTestAdapter.Height),
