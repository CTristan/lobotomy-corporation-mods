...
namespace LobotomyCorporationMods.Common.Implementations.Facades
{
    public static class CustomizeAgentUiFacade
    {
        ...
        public static void OpenAppearancePanel(
            [NotNull] this AgentInfoWindow agentInfoWindow,
        ...
        )
        {
            ...
            gameObjectTestAdapter = gameObjectTestAdapter.EnsureNotNullWithMethod(
                () => new GameObjectTestAdapter(agentInfoWindow.customizingBlock)
            );
            uiComponentsTestAdapter = uiComponentsTestAdapter.EnsureNotNullWithMethod(
                () => new AgentInfoWindowUiComponentsTestAdapter(agentInfoWindow.UIComponents)
            );
            customizingWindowTestAdapter = customizingWindowTestAdapter.EnsureNotNullWithMethod(
                () => new CustomizingWindowTestAdapter(agentInfoWindow.customizingWindow)
            );
        ...
        public static void SaveAppearanceData(
            [NotNull] this CustomizingWindow customizingWindow,
        ...
        )
        {
            ...
            agentLayerTestAdapter = agentLayerTestAdapter.EnsureNotNullWithMethod(
                () => new AgentLayerTestAdapter(AgentLayer.currentLayer)
            );
            workerSpriteManagerTestAdapter = workerSpriteManagerTestAdapter.EnsureNotNullWithMethod(
                () => new WorkerSpriteManagerTestAdapter(WorkerSpriteManager.instance)
            );
            ...
            workerSpriteManagerTestAdapter.SetAgentBasicData(
                customizingWindow.CurrentData.appearance.spriteSet,
        ...
        public static void UpdateAgentStats(
            this CustomizingWindow customizingWindow,
            [NotNull] AgentModel agent,
        ...
        )
        {
            ...
            customizingWindowTestAdapter = customizingWindowTestAdapter.EnsureNotNullWithMethod(
                () => new CustomizingWindowTestAdapter(customizingWindow)
            );

            agent.primaryStat.hp = customizingWindowTestAdapter.SetRandomStatValue(
                agent.primaryStat.hp,
                agent.originFortitudeLevel,
                agentData.statBonus.rBonus
            );
            agent.primaryStat.mental = customizingWindowTestAdapter.SetRandomStatValue(
                agent.primaryStat.mental,
                agent.originPrudenceLevel,
                agentData.statBonus.wBonus
            );
            agent.primaryStat.work = customizingWindowTestAdapter.SetRandomStatValue(
                agent.primaryStat.work,
                agent.originTemperanceLevel,
                agentData.statBonus.bBonus
            );
            agent.primaryStat.battle = customizingWindowTestAdapter.SetRandomStatValue(
                agent.primaryStat.battle,
                agent.originJusticeLevel,
                agentData.statBonus.pBonus
            );
