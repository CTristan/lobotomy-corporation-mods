...
namespace LobotomyCorporationMods.GiftAlertIcon.Constants
{
    internal static class LocalizationIds
    {
        ...
        internal const string ReplacementGiftTooltip1 = "GiftAlertIcon_ReplacementGiftTooltip1";
        internal const string ReplacementGiftTooltip2 = "GiftAlertIcon_ReplacementGiftTooltip2";
    }
}
