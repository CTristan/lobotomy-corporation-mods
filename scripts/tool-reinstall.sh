...
# Default tool name (playwright -> lobotomycorporationmods.playwright)
TOOL_NAME="${1:-playwright}"
PACKAGE_ID="lobotomycorporationmods.${TOOL_NAME}"
PROJECT_DIR="LobotomyPlaywright"
